      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* Search Results */}
            <div style={{ maxHeight: '400px', overflowY: 'auto', borderTop: '1px solid var(--border-color)' }}>
              {loading ? (
            ...
            >
              <div style={{ display: 'flex', gap: '1rem' }}>
                <span><kbd style={{ background: 'var(--bg-color-secondary)', padding: '0.1rem 0.3rem', borderRadius: '3px' }}>↑↓</kbd> to navigate</span>
                <span><kbd style={{ background: 'var(--bg-color-secondary)', padding: '0.1rem 0.3rem', borderRadius: '3px' }}>↵</kbd> to select</span>
              </div>
              <span><kbd style={{ background: 'var(--bg-color-secondary)', padding: '0.1rem 0.3rem', borderRadius: '3px' }}>esc</kbd> to close</span>
            </div>
          </div>
        </div>
      )}
