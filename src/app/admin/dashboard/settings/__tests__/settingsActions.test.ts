...
describe('updateSiteSettings', () => {
  ...
  it('should successfully update site settings when authorized', async () => {
    ...
    const args = ['New Title', 'favicon.ico', 'New Header Title', 'New Header Description', 'light', 'Footer Text', 'Sidebar About', true] as const
  ...
  it('should return error if database operation fails', async () => {
    ...
    const result = await updateSiteSettings('Title', null, 'Header Title', 'Header Description', 'dark', 'Footer Text', 'Sidebar About', true)
