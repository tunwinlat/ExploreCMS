...
describe('tagActions', () => {
  ...
  describe('deleteTag', () => {
    ...
    it('successfully deletes a tag when authorized as ADMIN', async () => {
      ...
      mockDelete.mockResolvedValueOnce({ id: 'tag-1', name: 'Test Tag', slug: 'test-tag' })
  ...
  describe('updateTag', () => {
    ...
    it('returns error if tag with the same name already exists', async () => {
      ...
      mockFindFirst.mockResolvedValueOnce({ id: 'tag-2', name: 'New Name', slug: 'new-name' })
    ...
    it('successfully updates a tag when authorized', async () => {
      ...
      mockUpdate.mockResolvedValueOnce({ id: 'tag-1', name: 'New Name', slug: 'new-name' })
